...
@AndroidEntryPoint
class AlgorandFirebaseMessagingService : FirebaseMessagingService() {
    ...
    override fun onMessageReceived(remoteMessage: RemoteMessage) {
        ...
        if (algorandNotificationManager.newNotificationLiveData.hasActiveObservers()) {
            algorandNotificationManager.newNotificationLiveData.postValue(Event(notificationData))
            return
        }
