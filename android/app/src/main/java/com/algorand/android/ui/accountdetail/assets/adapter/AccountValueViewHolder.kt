...
class AccountValueViewHolder(private val binding: ItemAccountValueBinding) : RecyclerView.ViewHolder(binding.root) {

    fun bind(accountValue: AccountDetailAssetsItem.AccountValueItem) {
        binding.accountValueTextView.text = accountValue.accountValue
    }
