...
class RemoveNotSupportedCollectibleItemViewHolder(
    ...
    override fun bindImage(collectibleImageView: CollectibleImageView, item: BaseRemoveCollectibleItem) {
        ...
        if (item is RemoveNotSupportedCollectibleItem) {
    ...
    companion object : RemoveCollectibleItemViewHolderCreator {
        override fun create(parent: ViewGroup): RemoveNotSupportedCollectibleItemViewHolder {
            return RemoveNotSupportedCollectibleItemViewHolder(createItemRemoveCollectibleBinding(parent))
        }
    }
}
