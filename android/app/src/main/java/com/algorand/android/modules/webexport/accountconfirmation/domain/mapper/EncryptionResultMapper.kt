...
class EncryptionResultMapper @Inject constructor() {

    fun mapToEncryptionResultSuccess(encryptedString: String): EncryptionResult.Success {
        return EncryptionResult.Success(
            encryptedString = encryptedString
        )
    }

    fun mapToEncryptionResultError(errorCode: Long?): EncryptionResult.Error {
