...
class AddAssetActionBottomSheet : BaseAssetActionBottomSheet() {
    ...
    private val args: AddAssetActionBottomSheetArgs by navArgs()
    ...
    override fun setPositiveButton(materialButton: MaterialButton) {
        ...
        materialButton.setOnClickListener {
            asset?.let { assetDescription ->
                ...
                setNavigationResult(ADD_ASSET_ACTION_RESULT, assetActionResult)
            }
    ...
    companion object {
        const val ADD_ASSET_ACTION_RESULT = "add_asset_action_result"
    }
}
