...
class GetLastKnownAccountBlockNumberUseCase @Inject constructor(
    ...
    suspend operator fun invoke(): CacheResult<Long>? {
        return accountBlockPollingRepository.getLastKnownAccountBlockNumber()
    }
}
