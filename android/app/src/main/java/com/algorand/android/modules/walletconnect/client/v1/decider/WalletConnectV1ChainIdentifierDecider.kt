...
package com.algorand.android.modules.walletconnect.client.v1.decider
...
class WalletConnectV1ChainIdentifierDecider @Inject constructor() {
    ...
    fun decideChainIdentifier(chainId: Long?): WalletConnect.ChainIdentifier {
        ...
        return when (chainId) {
            ...
            WalletConnectV1ChainIdentifier.BETANET.id -> WalletConnect.ChainIdentifier.BETANET
    ...
    fun decideChainId(chainIdentifier: WalletConnect.ChainIdentifier): Long {
        return when (chainIdentifier) {
            ...
            WalletConnect.ChainIdentifier.BETANET -> WalletConnectV1ChainIdentifier.BETANET.id
