...
class BottomNavigationAlgoPriceTapEventTracker @Inject constructor(
    peraEventTracker: PeraEventTracker
) : BaseEventTracker(peraEventTracker) {

    suspend fun logAlgoPriceTapEvent() {
        logEvent(ALGO_PRICE_TAP_EVENT_KEY)
    }

    companion object {
        private const val ALGO_PRICE_TAP_EVENT_KEY = "menu_tap_algoprice"
    }
}
