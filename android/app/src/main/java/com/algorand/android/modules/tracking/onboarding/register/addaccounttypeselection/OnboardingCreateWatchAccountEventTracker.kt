...
package com.algorand.android.modules.tracking.onboarding.register.addaccounttypeselection
...
class OnboardingCreateWatchAccountEventTracker @Inject constructor(
    ...
    companion object {
        private const val ONBOARDING_CREATE_WATCH_ACCOUNT_EVENT_KEY = "onboarding_createaccount_watch"
    }
}
