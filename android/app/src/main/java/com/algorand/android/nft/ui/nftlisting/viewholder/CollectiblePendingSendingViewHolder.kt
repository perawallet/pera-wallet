...
class CollectiblePendingSendingViewHolder(
    ...
    private fun loadPreview(
        item: BaseCollectibleListItem.BaseCollectibleItem.BasePendingCollectibleItem.PendingSendingItem
    ) {
        with(binding) {
    ...
    companion object : NftListViewHolderCreator {
        override fun create(parent: ViewGroup): BaseCollectibleListViewHolder {
            return CollectiblePendingSendingViewHolder(createItemNftListBinding(parent))
        }
    }
}
