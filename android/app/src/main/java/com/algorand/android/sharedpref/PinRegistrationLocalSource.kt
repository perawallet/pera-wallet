...
import com.algorand.android.utils.preference.LOCK_PASSWORD
import javax.inject.Inject

class PinRegistrationLocalSource @Inject constructor(
    ...
    override fun getData(defaultValue: String?): String? {
        return sharedPref.getString(LOCK_PASSWORD, defaultValue)
    }

    override fun getDataOrNull(): String? {
        return sharedPref.getString(LOCK_PASSWORD, null)
    }
