...
package com.algorand.android.transactiondetail.data.mapper
...
class TransactionDetailDTOMapper @Inject constructor() {
    ...
    fun mapTo(transactionDetailResponse: TransactionDetailResponse): TransactionDetailDTO {
        return with(transactionDetailResponse.transaction) {
