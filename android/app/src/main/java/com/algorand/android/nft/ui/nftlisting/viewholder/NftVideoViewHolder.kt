...
class NftVideoViewHolder(binding: ItemBaseCollectibleListBinding) : BaseCollectibleListViewHolder(binding) {
    ...
    private fun loadThumbnail(item: BaseCollectibleListItem.BaseCollectibleItem.CollectibleVideoItem) {
    ...
    companion object : NftListViewHolderCreator {
        override fun create(parent: ViewGroup): BaseCollectibleListViewHolder {
            return NftVideoViewHolder(createItemNftListBinding(parent))
        }
    }
}
