...
class WebExportAccountConfirmationPreviewMapper @Inject constructor() {

    fun mapTo(
        listItems: List<BaseAccountConfirmationListItem>,
        backupId: String,
        modificationKey: String,
        encryptionKey: String,
        isLoadingVisible: Boolean
    ): WebExportAccountConfirmationPreview {
        return WebExportAccountConfirmationPreview(
            listItems = listItems,
            backupId = backupId,
