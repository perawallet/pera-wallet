...
class GetTransactionDetailAccountUseCase @Inject constructor(
    ...
    suspend fun getTransactionToAccount(publicKey: String): TransactionDetailItem.AccountItem {
    ...
    fun getTransactionFromAccount(
        publicKey: String,
        showToolTipView: Boolean
    ): TransactionDetailItem.AccountItem {
    ...
    suspend fun getTransactionCloseToAccount(publicKey: String): TransactionDetailItem.AccountItem {
    ...
    private fun getAccountFromLocalAccountsByPublicKey(
        ...
        if (foundAccount != null) {
            return transactionDetailItemMapper.mapToWalletAccountItem(
                ...
                isCopyButtonVisible = true,
                isAccountAdditionButtonVisible = false,
                accountIcon = foundAccount.createAccountIcon(),
                showToolTipView = showToolTipView
            )
        }
        return null
