...
class RemoveAssetActionBottomSheet : BaseAssetActionBottomSheet() {
    ...
    private val args: RemoveAssetActionBottomSheetArgs by navArgs()
    ...
    override fun initArgs() {
        this@RemoveAssetActionBottomSheet.asset = args.assetAction.asset
    ...
    override fun setPositiveButton(materialButton: MaterialButton) {
        ...
        materialButton.setOnClickListener {
            asset?.let { assetDescription ->
                ...
                setNavigationResult(REMOVE_ASSET_ACTION_RESULT, assetActionResult)
            }
    ...
    override fun setNegativeButton(materialButton: MaterialButton) {
        materialButton.setText(R.string.keep_it)
        materialButton.setOnClickListener { navBack() }
    }

    companion object {
        const val REMOVE_ASSET_ACTION_RESULT = "remove_asset_action_result"
    }
}
