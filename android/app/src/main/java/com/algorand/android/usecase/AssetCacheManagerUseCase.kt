...
class AssetCacheManagerUseCase @Inject constructor(
    private val assetCacheManager: AssetCacheManager
) {
    fun getAssetCacheStatusFlow() = assetCacheManager.cacheStatusFlow

    fun isCacheStatusAtLeastEmpty() = assetCacheManager.cacheStatusFlow.value isAtLeast EMPTY
}
