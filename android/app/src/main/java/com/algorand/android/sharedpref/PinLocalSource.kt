...
class PinLocalSource @Inject constructor(
    sharedPreferences: SharedPreferences
) : SharedPrefLocalSource<String?>(sharedPreferences) {

    override val key: String = PIN_PREFERENCE_KEY
    ...
    companion object {
        val defaultPinPreferences = null
        private const val PIN_PREFERENCE_KEY = "lock_password"
    }
}
