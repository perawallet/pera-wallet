...
package com.algorand.android.modules.walletconnect.launchback.transaction.ui.mapper
...
class WcTransactionLaunchBackBrowserPreviewMapper @Inject constructor() {

    fun mapToWcTransactionLaunchBackBrowserPreview(
        iconResId: Int,
        iconTintResId: Int,
        ...
        return WcTransactionLaunchBackBrowserPreview(
            iconResId = iconResId,
