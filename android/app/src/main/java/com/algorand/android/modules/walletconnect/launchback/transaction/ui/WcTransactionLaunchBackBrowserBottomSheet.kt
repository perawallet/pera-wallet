...
@AndroidEntryPoint
class WcTransactionLaunchBackBrowserBottomSheet : WcLaunchBackBrowserBottomSheet() {

    override val wcLaunchBackBrowserViewModel: WcLaunchBackBrowserViewModel
        get() = wcTransactionLaunchBackBrowserViewModel

    private val wcTransactionLaunchBackBrowserViewModel by viewModels<WcTransactionLaunchBackBrowserViewModel>()
}
