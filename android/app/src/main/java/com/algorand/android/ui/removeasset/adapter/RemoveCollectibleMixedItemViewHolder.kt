...
class RemoveCollectibleMixedItemViewHolder(
    ...
    override fun bindImage(collectibleImageView: CollectibleImageView, item: BaseRemoveCollectibleItem) {
        ...
        if (item is BaseRemoveCollectibleItem.RemoveCollectibleMixedItem) {
    ...
    companion object : RemoveCollectibleItemViewHolderCreator {
        override fun create(parent: ViewGroup): RemoveCollectibleMixedItemViewHolder {
            return RemoveCollectibleMixedItemViewHolder(createItemRemoveCollectibleBinding(parent))
        }
    }
}
