...
class TransactionDetailPreviewMapper @Inject constructor() {
    ...
    fun mapTo(isLoading: Boolean, transactionDetailItemList: List<TransactionDetailItem>): TransactionDetailPreview {
        return TransactionDetailPreview(isLoading = isLoading, transactionDetailItemList = transactionDetailItemList)
    }
}
