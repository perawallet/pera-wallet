...
import com.algorand.android.modules.sorting.accountsorting.data.repository.AccountSortPreferenceRepositoryImpl
...
object AccountSortPreferenceModule {

    @Provides
    @Named(AccountSortPreferenceRepository.INJECTION_NAME)
    fun provideAccountSortPreferenceRepository(
        accountSortPreferencesLocalSource: AccountSortPreferencesLocalSource
    ): AccountSortPreferenceRepository {
        return AccountSortPreferenceRepositoryImpl(accountSortPreferencesLocalSource)
    }
}
