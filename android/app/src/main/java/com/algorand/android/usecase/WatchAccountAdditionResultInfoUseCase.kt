...
import com.algorand.android.models.BaseAccountAdditionResultInfoPreview.WatchAccountAAdditionResultInfoPreview
import javax.inject.Inject

class WatchAccountAdditionResultInfoUseCase @Inject constructor(
    private val accountManager: AccountManager,
    private val baseAccountAdditionResultInfoPreviewMapper: BaseAccountAdditionResultInfoPreviewMapper
) {

    fun getWatchAccountAdditionResultInfoPreview(): WatchAccountAAdditionResultInfoPreview {
        ...
        val firstButtonTextRes = if (isItFirstAccountThatAdded) R.string.start_using_pera else R.string.continue_text
        return baseAccountAdditionResultInfoPreviewMapper.mapToWatchAccountAdditionResultInfoPreview(
