...
class AccountHistoryFeeViewHolder(
    ...
    companion object {
        fun create(parent: ViewGroup): AccountHistoryFeeViewHolder {
            val binding = ItemAccountHistoryFeeBinding.inflate(LayoutInflater.from(parent.context), parent, false)
            return AccountHistoryFeeViewHolder(binding)
        }
    }
}
