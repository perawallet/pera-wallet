...
package com.algorand.android.modules.recovery.recoverypassphrase.ui.model
...
data class RecoverWithPassphrasePreview(
    ...
    val onGlobalErrorEvent: Event<Int>? = null,
    ...
    val onRecoverAccountEvent: Event<AccountCreation>?,
