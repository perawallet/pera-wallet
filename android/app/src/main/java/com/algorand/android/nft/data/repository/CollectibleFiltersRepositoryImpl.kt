...
import com.algorand.android.nft.data.cache.CollectibleFilterNotOwnedLocalSource
...
class CollectibleFiltersRepositoryImpl(
    ...
    override fun getOptedInNotOwnedCollectiblesPreference(defaultValue: Boolean): Boolean {
        return collectibleFilterNotOwnedLocalSource.getData(defaultValue)
    }

    override fun saveOptedInNotOwnedCollectiblePreference(showOptedInNotOwnedCollectibles: Boolean) {
