...
class TransactionItemTypeMapper @Inject constructor(
    private val transactionItemTypeDecider: TransactionItemTypeDecider
) {
    fun mapTo(transaction: Transaction): TransactionItemType {
        return transactionItemTypeDecider.provideTransactionItemType(transaction)
    }
}
