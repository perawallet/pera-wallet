...
@AndroidEntryPoint
class WalletConnectTransactionSingleBrowserFallbackBottomSheet : BaseWalletConnectSingleBrowserFallbackBottomSheet() {

    val args by navArgs<WalletConnectTransactionSingleBrowserFallbackBottomSheetArgs>()
