...
import com.algorand.android.nft.data.repository.CollectibleFiltersRepositoryImpl
...
object CollectibleFilterRepositoryModule {
    ...
    internal fun provideCollectibleFiltersRepository(
        ...
        return CollectibleFiltersRepositoryImpl(collectibleFilterNotOwnedLocalSource)
    }
}
