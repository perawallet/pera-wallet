...
data class WebExportAccountConfirmationPreview(
    val listItems: List<BaseAccountConfirmationListItem>,
    val backupId: String,
    val modificationKey: String,
    val encryptionKey: String,
    val isLoadingVisible: Boolean,
    val globalErrorEvent: Event<String>? = null,
    val requestSendSuccessEvent: Event<ExportBackupResponseDTO>? = null
)
