...
import com.algorand.android.models.BaseAccountAdditionResultInfoPreview.LedgerAccountAdditionResultInfoPreview
import javax.inject.Inject

class LedgerAccountAdditionResultInfoUseCase @Inject constructor(
    ...
    fun getLedgerAccountAdditionResultInfoPreview(numberOfAccountsAdded: Int): LedgerAccountAdditionResultInfoPreview {
        ...
        return baseAccountAdditionResultInfoPreviewMapper.mapToLedgerAccountAdditionResultInfoPreview(
