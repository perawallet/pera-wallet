...
class NotificationCenterPreviewMapper @Inject constructor() {
    ...
    fun mapTo(
        onGoingCollectibleDetailEvent: Event<Pair<String, Long>>? = null,
        onGoingAssetDetailEvent: Event<Pair<String, Long>>? = null,
        onHistoryNotAvailableEvent: Event<String>? = null,
        onTransactionEvent: Event<Pair<String, Long>>? = null,
        ...
        return NotificationCenterPreview(
            ...
            onGoingAssetDetailEvent = onGoingAssetDetailEvent,
