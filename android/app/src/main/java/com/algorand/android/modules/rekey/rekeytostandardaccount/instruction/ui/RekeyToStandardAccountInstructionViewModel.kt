...
@HiltViewModel
class RekeyToStandardAccountInstructionViewModel @Inject constructor(
    ...
    val rekeyToStandardAccountInstructionPreviewFlow: StateFlow<RekeyToStandardAccountInstructionPreview>
        get() = _rekeyToStandardAccountInstructionPreviewFlow

    private fun getInitialPreview(): RekeyToStandardAccountInstructionPreview {
