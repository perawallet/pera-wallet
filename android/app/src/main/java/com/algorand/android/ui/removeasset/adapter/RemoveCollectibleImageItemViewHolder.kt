...
class RemoveCollectibleImageItemViewHolder(
    ...
    override fun bindImage(collectibleImageView: CollectibleImageView, item: BaseRemoveCollectibleItem) {
        ...
        if (item is RemoveCollectibleImageItem) {
    ...
    companion object : RemoveCollectibleItemViewHolderCreator {
        override fun create(parent: ViewGroup): RemoveCollectibleImageItemViewHolder {
            return RemoveCollectibleImageItemViewHolder(createItemRemoveCollectibleBinding(parent))
        }
    }
}
