...
class CollectibleSendPreviewMapper @Inject constructor() {
    ...
    fun mapToInitialState(
        ...
        isCollectibleNameVisible: Boolean,
        isCollectionNameVisible: Boolean
    ): CollectibleSendPreview {
        return CollectibleSendPreview(
            collectibleId = collectibleId,
            collectibleMedias = collectibleMedias,
            collectibleName = collectibleName,
            isCollectibleNameVisible = isCollectibleNameVisible,
            collectionName = collectionName,
            isCollectionNameVisible = isCollectionNameVisible,
