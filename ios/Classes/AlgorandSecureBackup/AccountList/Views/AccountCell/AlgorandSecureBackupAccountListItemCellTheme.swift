...
//   AlgorandSecureBackupAccountListItemCellTheme.swift

import Foundation
import MacaroonUIKit
import UIKit

struct AlgorandSecureBackupAccountListItemCellTheme:
    StyleSheet,
    LayoutSheet {
    ...
    subscript (accessory: AlgorandSecureBackupAccountListItemAccessory) -> ImageStyle {
        switch accessory {
